...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    YZLiveItem *liveItem =_lives[indexPath.row];
    
    liveItem.stream_addr = @"rtmp://wspubdev.zaiwailiuxue.com/dev/132";
//    liveItem.stream_addr = @"rtmp://live.hkstv.hk.lxdns.com/live/hks";
    liveVc.live = liveItem;
